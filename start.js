...
function fetchReport(organisationUnit){
    ...
    return new Promise(function (resolve, reject) {
        ...
        var date = new Date();
        var outputFile = "tmp/report" + date.getFullYear() + "."  + (date.getMonth() + 1)+ "."  + date.getDay()+ "."  + date.getHours()+ "."  + date.getMinutes()+ "."  + date.getSeconds()+ "."  + date.getMilliseconds() + ".jpg"
        var childArgs = [
        ...
        childProcess.execFile(binPath, childArgs, function (err, stdout, stderr) {
            if (err) {
                ...
                attachments[organisationUnit.id] = {path: outputFile, type: "image/jpeg", name: organisationUnit.name + " Report.jpg"};
